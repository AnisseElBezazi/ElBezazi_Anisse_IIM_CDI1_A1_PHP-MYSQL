...
$client->setRedirectUri('http://localhost/Site-web-pokemon--main/Site-pokemon--page-2-et-filtre-/ElBezazi_Anisse_CDI1A1_IIM/callback2.php');//permet a google de vérifier qu'on a été rediriger vers la bonne page
